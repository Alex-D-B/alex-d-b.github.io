<p class="font-bold text-center">3D Maze Generation Algorithm</p>
<ul class="list-disc list-inside">
    <li>Created a randomly generating maze in 3D space utilizing a custom algorithm</li>
    <li>Debugged maze generation by leveraging preprocessor macros to compile additional components to alter maze generation</li>
</ul>
